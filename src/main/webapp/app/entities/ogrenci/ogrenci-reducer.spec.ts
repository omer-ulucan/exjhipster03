...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ogrenci.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OGRENCI_LIST actions', async () => {
    ...
    it('dispatches FETCH_OGRENCI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OGRENCI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OGRENCI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OGRENCI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OGRENCI actions', async () => {
      const expectedActions = [
        {
