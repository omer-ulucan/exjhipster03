...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ogretmen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OGRETMEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_OGRETMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OGRETMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OGRETMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OGRETMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OGRETMEN actions', async () => {
      const expectedActions = [
        {
