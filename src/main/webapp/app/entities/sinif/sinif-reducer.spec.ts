...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sinif.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINIF_LIST actions', async () => {
    ...
    it('dispatches FETCH_SINIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINIF actions', async () => {
      const expectedActions = [
        {
